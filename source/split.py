...
fname=fdir+"JWST/jw02736001001_02105_00001_nrcalong/jw02736001001_02105_00001_nrcalong_cal.fits"
...
for i in range(data.shape[0]):
	for j in range(data.shape[1]):
		if data[i][j]==0 or data[i][j]<0:
			wgt[i][j]=0
write_fits(fdir+rename[0:l1-5]+"wgt.fits",wgt)
...
+" -DETECT_MINAREA 18 -DETECT_THRESH 1.2 -DEBLEND_NTHRESH 32 -DEBLEND_MINCONT 0.065\
 -BACK_SIZE 100 -BACK_FILTERSIZE 3 -BACKPHOTO_TYPE LOCAL -CHECKIMAGE_TYPE -BACKGROUND -CHECKIMAGE_NAME "+\
 fdir+"re"+rename
os.system(cmd)
print(cmd)
